...
instructions1 = "Analyze the description of the product and provide a ranking on a scale of 1 to 5 based on its healthiness and nutritional value in comparison to other similar products in the same industry/type. Give me this ranking in the begining of the message in the format: 'RANK=x' where x is the rank. Provide a brief explanation of the ranking and suggest any alternative products that could be purchased as a healthier alternative. Also, provide a list of any potential allergens or harmful ingredients present in the product."

instructions2 = "Find the most healthy brand options or sustainably sourced brands for the category of ", query, " and provide a list of the top 5 brands. Provide a brief explanation of why these brands are considered healthier or more sustainable. Also, include any certifications or labels that these brands have received for their healthiness or sustainability."
